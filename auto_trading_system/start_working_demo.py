"""
Working Automated Trading Demo
A simplified version that bypasses complex configuration and works immediately.
"""
import asyncio
import json
import logging
...
logging.basicConfig(
    ...
    handlers=[logging.StreamHandler(), logging.FileHandler("working_trading_demo.log")],
)
...
class WorkingTradingEngine:
    """Working trading engine for demo"""
    ...
    def __init__(self):
        ...
        logger.info("Working Trading Engine initialized")
    ...
    async def start_trading(self, duration_minutes: int = 10):
        ...
        logger.info("[AI] Using OpenAI for trading decisions")
        logger.info("=" * 80)
        ...
        try:
            ...
            logger.info("[STOPPED] Trading stopped by user")
        finally:
            self.running = False
